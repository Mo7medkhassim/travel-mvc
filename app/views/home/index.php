				...
				<div class="owl-carousel active-post-carusel">
					<div class="post-box mb-30">
						<div class="d-flex">
							<div>
								<a href="#">
									<img src="<?= PATH; ?>front/img/author/a1.png" alt="">
								</a>
							</div>
							<div class="post-meta">
								<div class="meta-head">
		...
		<div class="row">
			<div class="col-lg-8 post-list">
				...
				<section class="post-area">
					<div class="single-post-item">
						<figure>
							<img class="post-img img-fluid" src="<?= PATH; ?>front/img/posts/p1.jpg" alt="">
						</figure>
						<h3>
							<a href="<?=PATH;?>home/blog">It's Hurricane Season But We Are Visiting Hilton Island</a>
						</h3>
						...
						<a href="<?=PATH;?>home/blog" class="primary-btn text-uppercase mt-15">continue Reading</a>
						<div class="post-box">
							<div class="d-flex">
								<div>
									<a href="#">
					...
					<div class="single-post-item">
						<figure>
							<img class="post-img img-fluid" src="<?= PATH; ?>front/img/posts/p2.jpg" alt="">
						</figure>
						<h3>
							<a href="<?=PATH;?>home/blog">Global Resorts Network Grn Putting Timeshares To Shame</a>
						</h3>
						<p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
							magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
						<a href="<?=PATH;?>home/blog" class="primary-btn text-uppercase mt-15">continue Reading</a>
					...
					<div class="single-post-item">
						<figure>
							<img class="post-img img-fluid" src="<?= PATH; ?>front/img/posts/p3.jpg" alt="">
						</figure>
						<h3>
							<a href="<?=PATH;?>home/blog">A Guide To Rocky Mountain Vacations</a>
						</h3>
						<p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
							magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
						<a href="<?=PATH;?>home/blog" class="primary-btn text-uppercase mt-15">continue Reading</a>
					...
					<div class="single-post-item">
						<figure>
							<img class="post-img img-fluid" src="<?= PATH; ?>front/img/posts/p4.jpg" alt="">
						</figure>
						<h3>
							<a href="<?=PATH;?>home/blog">Big Savings On Gas While You Travel</a>
						</h3>
						<p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
							magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
						<a href="<?=PATH;?>home/blog" class="primary-btn text-uppercase mt-15">continue Reading</a>
					...
					<div class="single-post-item">
						<figure>
							<img class="post-img img-fluid" src="<?= PATH; ?>front/img/posts/p5.jpg" alt="">
						</figure>
						<h3>
							<a href="<?=PATH;?>home/blog">Tourism Is Back In Full Swing In Cancun Mexico</a>
						</h3>
						<p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
							magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
						<a href="<?=PATH;?>home/blog" class="primary-btn text-uppercase mt-15">continue Reading</a>
			...
			<div class="col-lg-4 sidebar">
				...
				<div class="single-widget protfolio-widget">
					<img class="img-fluid" src="<?= PATH; ?>front/img/blog/user2.png" alt="">
					<a href="#">
					...
					<div class="blog-list ">
						<div class="single-popular-post d-flex flex-row">
							<div class="popular-thumb">
								<img class="<?= PATH; ?>front/img-fluid" src="img/blog/r1.jpg" alt="">
							</div>
							<div class="popular-details">
								<a href="<?=PATH;?>home/blog">
						...
						<div class="single-popular-post d-flex flex-row">
							<div class="popular-thumb">
								<img class="img-fluid" src="<?= PATH; ?>front/img/blog/r2.jpg" alt="">
							</div>
							<div class="popular-details">
								<a href="<?=PATH;?>home/blog">
						...
						<div class="single-popular-post d-flex flex-row">
							<div class="popular-thumb">
								<img class="img-fluid" src="<?= PATH; ?>front/img/blog/r3.jpg" alt="">
							</div>
							<div class="popular-details">
								<a href="<?=PATH;?>home/blog">
						...
						<div class="single-popular-post d-flex flex-row">
							<div class="popular-thumb">
								<img class="img-fluid" src="<?= PATH; ?>front/img/blog/r4.jpg" alt="">
							</div>
							<div class="popular-details">
								<a href="<?=PATH;?>home/blog">
